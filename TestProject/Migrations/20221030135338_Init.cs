    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookOrderItem", x => new { x.BooksId, x.OrderItemsId });
                    table.ForeignKey(
                        name: "FK_BookOrderItem_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookOrderItem_OrderItems_OrderItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookOrderItem_OrderItemsId",
                table: "BookOrderItem",
                column: "OrderItemsId");
